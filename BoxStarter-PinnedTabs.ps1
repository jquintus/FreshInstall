...
Install-ChocolateyPinnedTaskBarItem "C:\Program Files (x86)\Microsoft Visual Studio 12.0\Common7\IDE\devenv.exe" -ErrorAction SilentlyContinue
Install-ChocolateyPinnedTaskBarItem "C:\Program Files (x86)\Google\Chrome\Application\chrome.exe" -ErrorAction SilentlyContinue
Install-ChocolateyPinnedTaskBarItem "C:\Program Files (x86)\vim\vim74\gvim.exe" -ErrorAction SilentlyContinue
